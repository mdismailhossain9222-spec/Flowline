...
export const DEMO_EMAIL = 'demo@flowline.io'
export const DEMO_PASSWORD = 'workflow-2026'
...
const USERS_KEY = 'flowline.users.v1'
const SESSION_KEY = 'flowline.session.v1'
const ATTEMPTS_KEY = 'flowline.attempts.v1'
...
async function hashPassword(email: string, password: string) {
  const salted = `${password}::${email.toLowerCase()}::flowline-demo-v1`
  try {
